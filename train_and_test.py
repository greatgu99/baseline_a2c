...
#    goals['test'].append({'explicit_inform_slots': {'Burning sensation behind the breastbone': True}, 'implicit_inform_slots': {'Fever':False,'Diplopia':False,'Breast tenderness':False,'Stomach ache':False}, 'disease_tag': 'Esophagitis'})
    ...
    # goals['test'].append({'explicit_inform_slots': {'Chest tightness': True}, 'implicit_inform_slots': {'Pain behind the breastbone': True, 'Diarrhea': True, 'Acid reflux': True}, 'disease_tag': 'Esophagitis'})
    # goals['test'].append({'explicit_inform_slots': {'Hard to swallow': True, 'Cough': False}, 'implicit_inform_slots': {'Stomach ache': False, 'Fever': False, 'Chest tightness': True, 'Pain behind the breastbone': True, 'Feel sick and vomit': True}, 'disease_tag': 'Esophagitis'})
    # goals['test'].append({'explicit_inform_slots': {'Expectoration': True, 'Chest tightness': True, 'Vomiting': False, 'Fever': False}, 'implicit_inform_slots': {'Nausea': False, 'Runny nose': True}, 'disease_tag': 'Esophagitis'})
    # goals['test'].append({'explicit_inform_slots': {'Burning sensation behind the breastbone': True, 'Bloating': True}, 'implicit_inform_slots': {'Acid reflux': True}, 'disease_tag': 'Esophagitis'})
    # goals['test'].append({'explicit_inform_slots': {'Acid reflux': True}, 'implicit_inform_slots': {'Stomach ache': False, 'Bloating': False, 'Pain behind the breastbone': True}, 'disease_tag': 'Esophagitis'})
    # goals['test'].append({'explicit_inform_slots': {'Acid reflux': True, 'Burning sensation behind the breastbone': True, 'Stomach ache': False, 'Black stool': False}, 'implicit_inform_slots': {'Hematemesis': False}, 'disease_tag': 'Esophagitis'})
